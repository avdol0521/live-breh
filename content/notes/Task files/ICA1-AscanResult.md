---
title: "ICA1-AscanResult"
tags:
  - fetus
---
```sh
Starting Nmap 7.95 ( https://nmap.org ) at 2025-04-25 16:04 EDT
Stats: 0:00:23 elapsed; 0 hosts completed (1 up), 1 undergoing Script Scan
NSE Timing: About 97.30% done; ETC: 16:04 (0:00:00 remaining)
Stats: 0:00:25 elapsed; 0 hosts completed (1 up), 1 undergoing Script Scan
NSE Timing: About 97.53% done; ETC: 16:04 (0:00:00 remaining)
Stats: 0:00:27 elapsed; 0 hosts completed (1 up), 1 undergoing Script Scan
NSE Timing: About 99.21% done; ETC: 16:04 (0:00:00 remaining)
...
NSE Timing: About 99.33% done; ETC: 16:05 (0:00:00 remaining)
...
| http-csrf: 
| Spidering limited to: maxdepth=3; maxpagecount=20; withinhost=10.0.2.9
|   Found the following possible CSRF vulnerabilities: 
|     
|     Path: http://10.0.2.9:80/
|     Form id: loginform
|     Form action: http://10.0.2.9/index.php/login
|     
|     Path: http://10.0.2.9:80/index.php/login/restorePassword
|     Form id: restorepassword
|     Form action: /index.php/login/restorePassword
|     
|     Path: http://10.0.2.9:80/index.php/login
|     Form id: loginform
|_    Form action: http://10.0.2.9/index.php/login
...
|   Some Capabilities: Support41Auth, SwitchToSSLAfterHandshake, IgnoreSpaceBeforeParenthesis, SupportsCompression, InteractiveClient, DontAllowDatabaseTableColumn, LongColumnFlag, SupportsTransactions, ConnectWithDatabase, Speaks41ProtocolNew, FoundRows, ODBCClient, SupportsLoadDataLocal, IgnoreSigpipes, Speaks41ProtocolOld, LongPassword, SupportsMultipleResults, SupportsAuthPlugins, SupportsMultipleStatments
|   Status: Autocommit
|   Salt: oZyszu(\x7FQ:;*JV\x0E=T8-_
...
MAC Address: 08:00:27:27:8E:16 (PCS Systemtechnik/Oracle VirtualBox virtual NIC)
